...
const mainRoutes = [
  ...
  {
    path: 'account',
    element: <SuspenseWrapper><ProtectedRoute><AccountPage /></ProtectedRoute></SuspenseWrapper>
  },
  {
    path: 'orders',
    element: <SuspenseWrapper><ProtectedRoute><OrderHistoryPage /></ProtectedRoute></SuspenseWrapper>
  },
  {
    path: 'profile',
    element: <SuspenseWrapper><ProtectedRoute><ProfilePage /></ProtectedRoute></SuspenseWrapper>
  },
  {
    path: '*',
